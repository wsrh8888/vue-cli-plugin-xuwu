module.exports = {
  viteWebVue3ManuallyPc(language, toolName, frame) {
    return {
      when: (answers) => {
        return (
          language === 'web' &&
  ...
  viteWebVue3ManuallyMobile(language, toolName, frame) {
    return {
      when: (answers) => {
        return (
          language === 'web' &&
  ...
  viteWebVue2ManuallyPc(language, toolName, frame) {
    return {
      when: (answers) => {
        return (
          language === 'web' &&
  ...
  viteWebVue2ManuallyMobile(language, toolName, frame) {
    return {
      when: (answers) => {
        return (
          language === 'web' &&
  ...
  webpackWebVue3ManuallyPc(language, toolName, frame) {
    return {
      when: (answers) => {
        return (
          language === 'web' &&
  ...
  webpackWebVue3ManuallyMobile(language, toolName, frame) {
    return {
      when: (answers) => {
        return (
          language === 'web' &&
  ...
  webpackWebVue2ManuallyPc(language, toolName, frame) {
    return {
      when: (answers) => {
        return (
          language === 'web' &&
  ...
  webpackWebVue2ManuallyMobile(language, toolName, frame) {
